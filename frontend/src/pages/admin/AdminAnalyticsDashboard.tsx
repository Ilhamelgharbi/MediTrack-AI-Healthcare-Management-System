    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <BarChart3 className="animate-spin text-primary-600 mx-auto mb-4" size={48} />
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg text-gray-600">Comprehensive insights into medication adherence and patient management</p>
        </div>
      ...
      {overview && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card variant="elevated" className="relative overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                {getTrendIcon(overview.total_medications)}
              </div>
              <div className="space-y-2">
                <p className="text-sm font-medium text-gray-600">Total Medications</p>
                <h3 className="text-3xl font-bold text-green-600">{overview.total_medications}</h3>
          ...
          <Card variant="elevated" className="relative overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className={`p-3 rounded-xl ${getAdherenceBgColor(overview.average_adherence)}`}>
                  <Target className="w-5 h-5 text-purple-600" />
                </div>
                {getTrendIcon(overview.average_adherence)}
              </div>
              <div className="space-y-2">
                <p className="text-sm font-medium text-gray-600">Avg Adherence</p>
                <h3 className={`text-3xl font-bold ${getAdherenceColor(overview.average_adherence)}`}>
                  {overview.average_adherence.toFixed(1)}%
                </h3>
          ...
          <Card variant="elevated" className="relative overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                {getTrendIcon(overview.total_doses_today)}
              </div>
              <div className="space-y-2">
                <p className="text-sm font-medium text-gray-600">Doses Today</p>
                <h3 className="text-3xl font-bold text-orange-600">{overview.total_doses_today}</h3>
